...
1. **Uncovered roof AABB edges** — per sat roof/building footprint, four AABB sides. An edge is *covered* if some product plane has `|n · n_out| ≥ 0.7`, `|d + n·M| ≤ 2 m`, and center within 4 m of the segment. Uncovered edges become candidates.
